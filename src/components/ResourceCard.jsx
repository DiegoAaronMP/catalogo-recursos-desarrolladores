...
export const ResourceCard = ({ title, category, tags, description, image, url }) => {
    return (
        <a href={url} target='_blank' rel='noreferrer' className='flex flex-col rounded-xl border-[1.5px] border-gray-200 transition hover:bg-sky-50 hover:-translate-y-0.5 hover:ring-2 hover:ring-blue-400'>
